...
public class MainFrame extends JFrame {
	...
	protected JButton b_send = null;
	protected JButton b_exit = null;
	...
	/**
	 * This method initializes b_send	
	 * 	
	 * @return javax.swing.JButton	
	 */
	private JButton getB_send() {
		if (b_send == null) {
			b_send = new JButton();
			b_send.setText("Send");
		}
	...
	/**
	 * This method initializes b_exit	
	 * 	
	 * @return javax.swing.JButton	
	 */
	private JButton getB_exit() {
		if (b_exit == null) {
			b_exit = new JButton();
			b_exit.setText("Exit");
			b_exit.setPreferredSize(new Dimension(70, 25));
		}
		return b_exit;
	}
	...
	private JPanel getJPanel2() {
		if (jPanel2 == null) {
			...
			jPanel2.add(getB_send(), null);
			jPanel2.add(getB_exit(), null);
		}
		return jPanel2;
	}
	...
	public void setButtonListener(ActionListener al){
		this.b_connect.addActionListener(al);
		this.b_exit.addActionListener(al);
		this.b_send.addActionListener(al);
		this.b_stop.addActionListener(al);
	}
